...
class DetailInvitationPage extends GetView<DetailInvitationController> {
  const DetailInvitationPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        final event = controller.invitationData.value?.event;
        final outlet = controller.invitationData.value?.outlet;
        final invitation = controller.invitationData.value;
